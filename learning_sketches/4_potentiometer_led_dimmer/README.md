# Potentiometer to Adjust LED intensity

This project reads the analog value from a potentiometer on pin A0 and uses it to adjust the brightness level of an external LED.
